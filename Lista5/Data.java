...
public class Data {
    ...
    public int quantoDias(Data outraData){
        ...
        if(ehAnterior(outraData)){
            falta = -(ano - outraData.ano) * 365;
            falta -= (mes - outraData.mes) * 30;
            falta -= dia - outraData.dia;
            falta++;
        }else{
            falta = (outraData.ano - ano) * 365;
            falta += (outraData.mes - mes) * 30;
            falta += outraData.dia - dia;
            falta--;
        }
